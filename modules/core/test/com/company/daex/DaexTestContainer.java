...
public class DaexTestContainer extends TestContainer {

    public DaexTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/daex/app.properties",
    ...
    public static class Common extends DaexTestContainer {

        public static final DaexTestContainer.Common INSTANCE = new DaexTestContainer.Common();
